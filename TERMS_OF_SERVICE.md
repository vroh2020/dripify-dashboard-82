...
### Account Creation
- You must create an account using Apple Sign-In to use the App
...
- Upload photos of yourself or photos you have permission to use
- Share your style analysis results with others
...
- You grant us a license to process your photos for style analysis
- You are responsible for ensuring you have rights to upload any photos

### Our Content
- The App, including its design, code, and AI algorithms, is our property
- Style analysis results are provided for your personal use
...
- Subscription fees are charged through the App Store
- Prices are subject to change with notice

### Payment Terms
- Payments are processed by Apple and RevenueCat
...
- We use Supabase for secure data storage and processing
...
### AI Analysis
- Style analysis is provided for entertainment and guidance only
- Results are not professional fashion advice
...
- We will work in good faith to resolve disputes informally

### Formal Resolution
- If informal resolution fails, disputes will be resolved through binding arbitration
- Arbitration will be conducted in [Your City, State]
...
These Terms are between you and us, not with Apple. Apple is not responsible for the App and its content. Apple has no obligation to provide maintenance and support for the App.

---

*These Terms of Service are effective as of July 9, 2025.* 