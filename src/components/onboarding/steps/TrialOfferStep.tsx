  ...
  return (
    ...
    >
      <div className="w-full max-w-md mx-auto flex flex-col items-center bg-black/70 rounded-3xl shadow-2xl p-8 border border-white/10">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-white text-center mb-6 tracking-tight">We offer a monthly plan of $9.99 per month for you to enjoy Dripify AI.</h1>
