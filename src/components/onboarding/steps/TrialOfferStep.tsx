  ...
  return (
    ...
    >
      <div className="w-full max-w-md mx-auto flex flex-col items-center bg-black/70 rounded-3xl shadow-2xl p-8 border border-white/10">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold text-white text-center mb-4 tracking-tight">Unlock Drip AI Pro</h1>
        <p className="text-lg text-white/80 text-center mb-8">Get unlimited style analyses and personalized recommendations.</p>
