-- VERIFY DATA SAVED AFTER RLS FIX (FINAL CORRECTED VERSION)
...
-- Check specific user's onboarding data
SELECT 
    user_id,
    current_step,
    step_data,
...
-- Check specific user's analytics
SELECT 
    user_id,
    action,
    data,
...
-- Check specific user's analysis results
SELECT 
    user_id,
    score,
    image_url,
...
-- ============================================================================
-- PART 6: QUICK USER SUMMARY
-- ============================================================================

-- Quick summary for the specific user
SELECT 
    'onboarding_v2' as table_name,
    COUNT(*) as record_count,
